var TabulatorFormViewModel = (function () {
    function TabulatorFormViewModel() {
        this._data = [];
        this.dataSourceType = 'real';
        this.exampleModel = new TabulatorService();
    }
    TabulatorFormViewModel.prototype.getViewList = function (table) {
        switch (table) {
            case 'table1':
    ...
    TabulatorFormViewModel.prototype.read = function () {
        var _this = this;
