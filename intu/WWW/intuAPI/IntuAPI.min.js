// mB v6.07.21 on 2019-07-11T00:02:05.663Z
...
return this.serviceRPC.invoke("api","editors","check-editor",{editor_email:e,editor_pass:t}).then(function(n){return!!n&&(i.serviceRPC.setUser(e,t),!0)})},IntuAPI.prototype.getDirsList=function(){var e=window.sessionStorage.getItem("username"),t=window.sessionStorage.getItem("password")
...
return this.serviceRPC.invoke("api","admin","check-admin",{admin_email:e,admin_pass:t}).then(function(n){return!!n&&(i.serviceRPC.setUser(e,t),!0)})},IntuAPI.prototype.setupApp=function(e){var t=window.sessionStorage.getItem("username"),i=window.sessionStorage.getItem("password")
...
return this.serviceRPC.invoke("api","admin","get-editors",{admin_email:e,admin_pass:t})},IntuAPI.prototype.addEditor=function(e,t,i){var n=window.sessionStorage.getItem("username"),o=window.sessionStorage.getItem("password")
return this.serviceRPC.invoke("api","admin","add-editor",{name:e,email:t,password:i,admin_email:n,admin_pass:o})},IntuAPI.prototype.editEditor=function(e,t){return this.serviceRPC.invoke("api","admin","edit-editor",{name:t,uid:e,admin_email:window.sessionStorage.getItem("username"),admin_pass:window.sessionStorage.getItem("password")})},IntuAPI.prototype.deleteEditor=function(e){return this.serviceRPC.invoke("api","admin","delete-editor",{uid:e,admin_email:window.sessionStorage.getItem("username"),admin_pass:window.sessionStorage.getItem("password")})},IntuAPI.prototype.sendVcode=function(e){return this.serviceRPC.invoke("api","admin","resetPassword-code",{admin_email:e}).then(function(){return!0})},IntuAPI.prototype.resetPass=function(e,t,i){return this.serviceRPC.invoke("admin","admin","reset-password",{admin_email:e,code:t,password:i})},IntuAPI.prototype.getConfig=function(){var e=window.sessionStorage.getItem("username"),t=window.sessionStorage.getItem("password")
return this.serviceRPC.invoke("api","admin","get-config",{admin_email:e,admin_pass:t})},IntuAPI.prototype.updateConfig=function(e,t,i){var n=window.sessionStorage.getItem("username"),o=window.sessionStorage.getItem("password")
