// mB v6.07.25 on 2019-07-18T11:14:08.853Z
...
return this.serviceRPC.invoke("admin","admin","addEditor",{guid:e,name:t,email:i,password:n,admin_email:o,admin_pass:s})},IntuAPI.prototype.editEditor=function(e,t){return this.serviceRPC.invoke("admin","admin","edit-editor",{name:t,uid:e,admin_email:window.sessionStorage.getItem("username"),admin_pass:window.sessionStorage.getItem("password")})},IntuAPI.prototype.deleteEditor=function(e){return this.serviceRPC.invoke("admin","admin","deleteEditor",{uid:e,admin_email:window.sessionStorage.getItem("username"),admin_pass:window.sessionStorage.getItem("password")})},IntuAPI.prototype.sendVcode=function(e){return this.serviceRPC.invoke("api","admin","resetPassword-code",{admin_email:e}).then(function(){return!0})},IntuAPI.prototype.resetPass=function(e,t,i){return this.serviceRPC.invoke("admin","admin","reset-password",{admin_email:e,code:t,password:i})},IntuAPI.prototype.getConfig=function(){var e=window.sessionStorage.getItem("username"),t=window.sessionStorage.getItem("password")
