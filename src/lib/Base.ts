...
export class DownloadFrag {
   constructor(dir) {
      ...
      download('https://unpkg.com/setup-depp-defs@0.6.14/template/headFrag.pug').then(data => {
         fs.writeFileSync(dir+'/headFrag.pug', data)
     })
     download('https://unpkg.com/setup-depp-defs@0.6.14/template/devOps.pug').then(data => {
