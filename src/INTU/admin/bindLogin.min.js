...
function login(e,n,o){o.checkAdmin(e,n).then((function(o){o?(window.sessionStorage.setItem("username",e),window.sessionStorage.setItem("password",n),window.location="/admin/settings"):window.location="/admin"}))}function signOut(){sessionStorage.removeItem("username"),sessionStorage.removeItem("password"),""!==window.location.pathname&&"/admin"!==window.location.pathname&&window.location.replace("/admin")}depp.define({loginViewModel:["/admin/models/LoginViewModel.js"]}),depp.require("loginViewModel"),depp.require(["ui","scripts","loginViewModel"],(async function(){var e=await LoginViewModel.inst()
