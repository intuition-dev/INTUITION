...
depp.define({
    ...
    'pop-custelX': ['https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v2.10.14/custel/pop/custel/pop-custel.js'],
    ...
    'httpRPC': ['https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v2.10.14/http-rpc+/web/httpRPC.js'],
    'intuAPI': ['/intuAPI/IntuAPI.js'],
    'baseVM': ['https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v2.10.14/http-rpc+/web/httpRPC.js', '#intuAPI', '/edit/assets/models/BaseViewModel.js',],
