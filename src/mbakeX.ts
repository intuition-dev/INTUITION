...
function help() {
   ...
   console.info('  To export Firestore Database:                               mbakeX --ExportDB serviceAccountKey.json')
   console.info('  To import Firestore Database needs two arguments separated with ":" : mbakeX --ImportDB serviceAccountKey.json:name_of_the_json_exported_file.json')
