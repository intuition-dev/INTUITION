...
let t=window.appMount[0]
$(".view-page").attr("href",t),$(document).off().on("click",".blog-item",function(i){i.preventDefault(),$(".blog-item ul").remove(),$(".upload, .i-plusCircle").removeClass("disabled"),$(".knot").removeClass("active"),$(this).find(".knot").addClass("active"),$(".blog-item").removeClass("active"),$(this).addClass("active"),$(".btn-custom.save").attr("disabled","disabled"),$(".view-page").removeAttr("disabled")
let a=$(this).find("span").text()
window.location.hash=a,$(".view-page").attr("href",t+"/"+a),0===$(this).find("ul").length?e.showSubDirs(a).then(()=>{$(".blog-item li").each(function(){let e=$(this).text()
