...
addEventListener('evtName', function(evt) {}), depp.define({
 pre: [ 'https://cdn.jsdelivr.net/npm/jquery@3.3.1/dist/jquery.slim.min.js', 'https://cdn.jsdelivr.net/npm/js-offcanvas@1.2.8/dist/_js/js-offcanvas.pkgd.js', 'https://cdn.jsdelivr.net/npm/js-offcanvas@1.2.8/dist/_css/prefixed/js-offcanvas.css', ROOT + 'assets/3rd/gridform.css', 'https://cdn.jsdelivr.net/npm/is_js@0.9.0/is.min.js' ],
 ...
 css: [ '#tabLoaded', ROOT + 'assets/3rd/spectre.css', ROOT + 'assets/3rd/nav.css', ROOT + 'assets/css/main.css', 'css!https://fonts.googleapis.com/css?family=Open+Sans' ]
