...
_mbake_ compares to other generators listed at http://staticgen.com.

_mbake_ includes sample starter apps for CRUD and mock-ups. After you are comfortable with mbake, check out B-M-SPA and Meta.
...
The best way to get started with mbake is to read [the docs](http://doc.metabake.org/mbake/).
