...
depp.require(['poly-custel', 'mustache'], function () { // inside the require
   ...
   c2Temp.innerHTML = `
      {{#items}}
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/intuition-dev/toolBelt@v1.9.14/bootStrap/css/bootstrapTop.css">
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/intuition-dev/toolBelt@v1.9.14/bootStrap/css/bootstrap.css">
