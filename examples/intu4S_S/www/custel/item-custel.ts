...
depp.require(['poly-custel', 'mustache'], function () { // inside the require
   ...
   cTemp.innerHTML = `
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/intuition-dev/toolBelt@v1.9.2/bootStrap/css/bootstrapTop.css">
      <a href="{{url}}">
   ...
   c2Temp.innerHTML = `
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/intuition-dev/toolBelt@v1.9.2/bootStrap/css/bootstrapTop.css">
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/intuition-dev/toolBelt@v1.9.2/bootStrap/css/bootstrap.css">
      <a href="{{url}}">
      <div class="card m-1" style="max-width:400px">
