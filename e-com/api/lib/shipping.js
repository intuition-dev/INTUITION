...
class ShippingRoutes {
    routes(appPort) {
        ...
        const shippingApp = Serv_1.ExpressRPC.makeInstance(['http://localhost:' + appPort]);
        shippingApp.use(bodyParser.json());
        shippingApp.post('/printful-rate', function (req, res) {
        ...
        shippingApp.post('/printful-create-order', (req, res) => {
