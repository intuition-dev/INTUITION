...
depp.require(['poly-wcomp', 'mustache'], function(){ // inside the require
   ...
   cTemp.innerHTML = `
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/metabake/toolBelt@v2.0.17/bootStrap/css/bootstrapTop.css">
      <a href="{{url}}">
   ...
   c2Temp.innerHTML = `
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/metabake/toolBelt@v2.0.17/bootStrap/css/bootstrapTop.css">
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/metabake/toolBelt@v2.0.17/bootStrap/css/bootstrap.css">
      <a href="{{url}}">
      <div class="card" style="max-width:400px">
